...
public class BreadSwerveDrivetrain {
  ...
  protected Pigeon2
      m_pigeon2; // TODO: Make this an AdvantageKit I/O class for the main thread (Odometry thread
  // still needs direct access)
  ...
  protected SwerveDrivePoseEstimator
      m_AutoOdometry; // TODO: Make this an AdvantageKit I/O class for the main thread (Odometry
  // thread still needs direct access)
  protected SwerveDrivePoseEstimator
      m_ShotOdometry; // TODO: Make this an AdvantageKit I/O class for the main thread (Odometry
  // thread still needs direct access)
